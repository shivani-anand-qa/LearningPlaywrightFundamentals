...
<body>
    <div class="header"><h1>📊 Report History</h1>${process.env.CLIENT_NAME ? `<p>${process.env.CLIENT_NAME}</p>` : ''}</div>
...
<body>
    <div class="header">
        ...
        ${process.env.CLIENT_NAME ? `<p class="header-subtitle">${this.escapeHtml(process.env.CLIENT_NAME)}</p>` : ''}
    </div>
